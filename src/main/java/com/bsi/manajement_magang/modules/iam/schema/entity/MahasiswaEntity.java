...
public class MahasiswaEntity {
    ...
    public MahasiswaEntity(UUID id, UUID userId, String nim, String nama, String noHp) {
        this.id = id;
        this.userId = userId;
        this.nim = nim;
        this.nama = nama;
    ...
    public MahasiswaEntity(UUID id, UUID userId, String nim, String nama, String noHp, String gender, String universitas) {
        this.id = id;
        this.userId = userId;
        this.nim = nim;
        this.nama = nama;
