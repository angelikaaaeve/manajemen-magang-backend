package com.bsi.manajement_magang.modules.dashboard_mahasiswa.service.impl;

import com.bsi.manajement_magang.modules.dashboard_mahasiswa.repository.DashboardMahasiswaRepository;
...
@Service
public class DashboardMahasiswaServiceImpl implements DashboardMahasiswaService {
    private final DashboardMahasiswaRepository repository;

    public DashboardMahasiswaServiceImpl(DashboardMahasiswaRepository repository) {
