...
public class PenilaianRepository {
    ...
    private PenilaianResponse mapPenilaianResponse(ResultSet rs, int rowNum) throws SQLException {
        ...
        return new PenilaianResponse(
            ...
            kinerja != null ? kinerja : BigDecimal.ZERO,
            kedisiplinan != null ? kedisiplinan : BigDecimal.ZERO,
            tanggungJawab != null ? tanggungJawab : BigDecimal.ZERO,
            komunikasi != null ? komunikasi : BigDecimal.ZERO,
            sikap != null ? sikap : BigDecimal.ZERO,
            kerapihan != null ? kerapihan : BigDecimal.ZERO,
            absensi != null ? absensi : BigDecimal.ZERO,
            kerjasama != null ? kerjasama : BigDecimal.ZERO,
            nilaiTotal != null ? nilaiTotal : BigDecimal.ZERO,
