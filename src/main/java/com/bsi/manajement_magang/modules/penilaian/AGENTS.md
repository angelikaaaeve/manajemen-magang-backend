...
Get internship evaluation logs.
...
[
  {
    ...
    "absensi": 96.0,
    "kerjasama": 88.0,
    "nilaiTotal": 88.0, // calculated weight or simple average
...
Industry supervisor submits scores for a student.
...
```json
{
  ...
  "mentorId": "3cb1ab0d-4ea3-4cfb-81d0-d3cdb2413e11", // Required
...
Retrieve general evaluation metrics.
